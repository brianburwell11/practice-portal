---
title: "Moving All Config Data from Repo to R2"
description: "Plan for migrating all config data (bands, songs, manifests) from the git repo to Cloudflare R2 — enabling admin CRUD without git commits."
pubDate: "Apr 10 2026"
tags: ["infrastructure", "cloudflare", "r2", "architecture"]
---

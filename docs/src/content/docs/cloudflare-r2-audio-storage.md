---
title: "Moving Audio Storage to Cloudflare R2"
description: "Why we chose Cloudflare R2 for external audio storage, the presigned URL upload architecture, transcoding pipeline, and migration plan from local files."
pubDate: "Apr 10 2026"
tags: ["infrastructure", "cloudflare", "r2", "audio", "research"]
---
